				...
				<div class="site-copy-down">
					<div class="site-info">
						...
						<?php 
							...
							printf( esc_html__( 'WordPress Theme: %1$s by %2$s.', 'elementare' ), '<a target="_blank" href="https://crestaproject.com/downloads/elementare/" rel="nofollow" title="Elementare Theme">Elementare</a>', 'CrestaProject' );
						?>
					</div><!-- .site-info -->
